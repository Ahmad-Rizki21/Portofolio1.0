...
!(function(t) {
    ...
    (n = {
        ...
        isElement: function(e, n) {
            return (
                (n = n || t.document), !!(t.HTMLElement && e instanceof t.HTMLElement) ||
                !!(
                    n.defaultView &&
    ...
    e.BaseStatic.call(e.Features),
        ...
        n.extend(e.Control.prototype, {
                ...
                if (
                    (this.callActions("beforeHandleClick", arguments),
                        ...
                        (i = a.selector ?
                            n.closestParent(
                                t.target,
                                o.config.selectors.control + a.selector, !0,
                                o.dom.document
                            ) :
                            a.el), !i)
                )
            ...
            updateLive: function(t, n) {
                ...
                if ((a.callActions("beforeUpdateLive", arguments), a.el)) {
                    for (i = a.el.querySelectorAll(a.selector), s = 0;
                        (r = i[s]); s++) {
        ...
        n.extend(e.Mixer.prototype, {
            ...
            buildState: function(t) {
                ...
                for (o = 0;
                    (i = t.matching[o]); o++) a.matching.push(i.dom.el);
                for (o = 0;
                    (i = t.show[o]); o++) a.show.push(i.dom.el);
                for (o = 0;
                    (i = t.hide[o]); o++)
                    (!t.toRemove.length || t.toRemove.indexOf(i) < 0) &&
            ...
            goMix: function(a, i) {
                ...
                return (
                    ...
                    e.events.fire(
                        "mixStart",
                        o.dom.container, { state: i.startState, futureState: i.newState, instance: o },
                        o.dom.document
                    ),
            ...
            cleanUp: function(t) {
                ...
                for (
                    ...
                    i.cleanUp(), i.show();
                for (l = 0;
                    (i = t.toHide[l]); l++) i.cleanUp(), i.hide();
                if (
                ...
                t.willSort && (a.targets = t.newOrder),
                    ...
                    e.events.fire(
                        "mixEnd",
                        a.dom.container, { state: a.state, instance: a },
                        a.dom.document
                    ),
            ...
            parseMultimixArgs: function(t) {
                ...
                return (!i.command.insert ||
                    ...
                    (i.command.insert = a.parseInsertArgs([i.command.insert]).command), !i.command.remove ||
                    i.command.remove instanceof e.CommandRemove ||
                    (i.command.remove = a.parseRemoveArgs([i.command.remove]).command), !i.command.filter ||
                    i.command.filter instanceof e.CommandFilter ||
                    (i.command.filter = a.parseFilterArgs([i.command.filter]).command), !i.command.sort ||
                    i.command.sort instanceof e.CommandSort ||
                    (i.command.sort = a.parseSortArgs([i.command.sort]).command), !i.command.changeLayout ||
            ...
            destroy: function(t) {
                ...
                for (
                    ...
                    a.removeBinding(n);
                for (o = 0;
                    (i = n.targets[o]); o++) t && i.show(), i.unbindEvents();
            ...
            applyStylesOut: function(t) {
                ...
                switch (
                    ((n.operation = t.operation),
                        (n.callback = t.callback), !n.isExcluded && n.mixer.targetsBound++,
                        (n.isBound = !0),
                        n.applyTransition(a),
                        o &&
                        t.posOut.width > 0 &&
